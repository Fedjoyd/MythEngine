...
//Operateurs
bool        Vec4::operator==  (Vec4 const& p_vector)   const
{
...
Vec4&    Vec4::operator=   (Vec4 const& p_other)
{
    m_x = p_other.m_x;
     m_y = p_other.m_y;
     m_z = p_other.m_z;
...
float       Vec4::operator[]  (unsigned int const    p_index)    const
{
...
float&      Vec4::operator[]  (unsigned int const    p_index)
{
	return (p_index == 3)? m_w :
           (p_index == 2)? m_z :
           (p_index == 1)? m_y : m_x;
}
Vec4     Vec4::operator+   (Vec4 const& p_vector)   const
{
    return {m_x+p_vector.m_x,  m_y+p_vector.m_y,  m_z+p_vector.m_z,  m_w+p_vector.m_w};
}
Vec4     Vec4::operator+   (float const    p_value)    const
{
    return {m_x + p_value,  m_y + p_value,  m_z + p_value,  m_w + p_value };
}
Vec4&    Vec4::operator+=  (Vec4 const& p_vector)
{
    m_x += p_vector.m_x;
     m_y += p_vector.m_y;
     m_z += p_vector.m_z;
...
Vec4&    Vec4::operator+=  (float const    p_value)
{
    m_x += p_value;
     m_y += p_value;
     m_z += p_value;
...
Vec4     Vec4::operator*   (float const    p_scale)    const
{
...
Vec4&    Vec4::operator*=  (float const    p_scale)
{
    m_x *= p_scale;
     m_y *= p_scale;
     m_z *= p_scale;
